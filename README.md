<p align="center">
  <img src="assets/dashboard-screenshot.png" alt="OpenClaw AI Team Dashboard" width="100%">
</p>

<h1 align="center">🦞 OpenClaw AI Team Dashboard UI</h1>

<p align="center">
  <strong>一个可直接安装到 OpenClaw 的 AI Team 调度中心定制前端</strong>
</p>

<p align="center">
  <a href="https://github.com/davechang1774-afk/openclaw-ai-team-dashboard-ui/releases/tag/v2026.03.13">
    <img src="https://img.shields.io/badge/version-v2026.03.13-blue.svg" alt="Version">
  </a>
  <a href="https://github.com/davechang1774-afk/openclaw-ai-team-dashboard-ui/blob/main/LICENSE-STATUS.md">
    <img src="https://img.shields.io/badge/license-See%20LICENSE--STATUS-yellow.svg" alt="License">
  </a>
  <a href="https://www.npmjs.com/package/openclaw">
    <img src="https://img.shields.io/badge/OpenClaw-2026.3.x-green.svg" alt="OpenClaw">
  </a>
</p>
...
| 功能 | 说明 |
|------|------|
| 🤖 Bots 面板 | 自动读取 `agents.list`，展示 6 个 Agent 状态 |
| 📊 实时监控 | 会话、代码提交、模型路由、skills 展示 |
| 🔄 Fallback 状态 | 实际命中 fallback 状态显示 |
| 💬 Feishu 群映射 | 群会话映射与展示 |
| 🎴 Skills 卡片 | 可折叠 skills 卡片 |
| ✏️ 输入优化 | 可拉伸输入框与滚动位置保持 |
| 🔗 署名声明 | 页面底部原作者链接与二次改造声明 |
...
<p align="center">
  Made with ❤️ by <a href="https://github.com/davechang1774-afk">davechang1774-afk</a>
</p>